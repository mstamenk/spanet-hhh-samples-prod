...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,6),W(1,3),W(1,9),GC_11,AMP(4))
      CALL FFV1_1(W(1,3),W(1,7),GC_11,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,4),W(1,6),W(1,9),GC_11,AMP(5))
      CALL FFV1_2(W(1,1),W(1,8),GC_11,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,6),W(1,2),W(1,9),GC_11,AMP(6))
      CALL FFV1_2(W(1,1),W(1,9),GC_11,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,6),W(1,2),W(1,8),GC_11,AMP(7))
