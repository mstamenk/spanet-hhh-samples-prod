...
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,12),W(1,3),W(1,11),GC_11,AMP(23))
      CALL FFV1_2(W(1,15),W(1,2),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,10),W(1,4),W(1,8),GC_11,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL VVV1_0(W(1,2),W(1,8),W(1,11),GC_10,AMP(25))
...
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,7),W(1,3),W(1,9),GC_11,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,12),W(1,3),W(1,11),GC_11,AMP(31))
...
C     Amplitude(s) for diagram number 34
      CALL VVVV1_0(W(1,1),W(1,2),W(1,8),W(1,9),GC_12,AMP(34))
      CALL VVVV3_0(W(1,1),W(1,2),W(1,8),W(1,9),GC_12,AMP(35))
      CALL VVVV4_0(W(1,1),W(1,2),W(1,8),W(1,9),GC_12,AMP(36))
C     Amplitude(s) for diagram number 35
      CALL VVV1_0(W(1,2),W(1,9),W(1,14),GC_10,AMP(37))
C     Amplitude(s) for diagram number 36
      CALL VVV1_0(W(1,2),W(1,8),W(1,11),GC_10,AMP(38))
