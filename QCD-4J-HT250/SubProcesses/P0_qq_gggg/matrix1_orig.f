...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL VVV1P0_1(W(1,5),W(1,6),GC_10,ZERO, FK_ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1_1(W(1,2),W(1,5),GC_11,ZERO, FK_ZERO,W(1,12))
      CALL VVV1P0_1(W(1,7),W(1,6),GC_10,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,1),W(1,12),W(1,13),GC_11,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,10),W(1,12),W(1,6),GC_11,AMP(5))
      CALL FFV1_2(W(1,1),W(1,6),GC_11,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,14),W(1,12),W(1,7),GC_11,AMP(6))
      CALL FFV1_2(W(1,1),W(1,5),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,15),W(1,2),W(1,13),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,15),W(1,9),W(1,6),GC_11,AMP(8))
      CALL FFV1_1(W(1,2),W(1,6),GC_11,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,15),W(1,16),W(1,7),GC_11,AMP(9))
      CALL VVV1P0_1(W(1,7),W(1,5),GC_10,ZERO, FK_ZERO,W(1,17))
...
C     Amplitude(s) for diagram number 16
      ...
      CALL VVV1P0_1(W(1,3),W(1,5),GC_10,ZERO, FK_ZERO,W(1,13))
      CALL VVV1P0_1(W(1,4),W(1,6),GC_10,ZERO, FK_ZERO,W(1,17))
      CALL FFV1_1(W(1,2),W(1,13),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,1),W(1,7),W(1,17),GC_11,AMP(19))
      CALL FFV1_2(W(1,1),W(1,13),GC_11,ZERO, FK_ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 19
      ...
      CALL VVV1P0_1(W(1,13),W(1,6),GC_10,ZERO, FK_ZERO,W(1,18))
...
C     Amplitude(s) for diagram number 22
      ...
      CALL FFV1_2(W(1,1),W(1,4),GC_11,ZERO, FK_ZERO,W(1,19))
...
C     Amplitude(s) for diagram number 25
      ...
      CALL VVV1P0_1(W(1,13),W(1,4),GC_10,ZERO, FK_ZERO,W(1,20))
...
C     Amplitude(s) for diagram number 32
      ...
      CALL VVV1P0_1(W(1,3),W(1,6),GC_10,ZERO, FK_ZERO,W(1,18))
      CALL VVV1P0_1(W(1,4),W(1,5),GC_10,ZERO, FK_ZERO,W(1,20))
...
C     Amplitude(s) for diagram number 33
      ...
      CALL FFV1_2(W(1,1),W(1,18),GC_11,ZERO, FK_ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 35
      ...
      CALL VVV1P0_1(W(1,18),W(1,5),GC_10,ZERO, FK_ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 41
      ...
      CALL VVV1P0_1(W(1,18),W(1,4),GC_10,ZERO, FK_ZERO,W(1,21))
...
C     Amplitude(s) for diagram number 48
      ...
      CALL FFV1_1(W(1,9),W(1,6),GC_11,ZERO, FK_ZERO,W(1,21))
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,1),W(1,21),W(1,20),GC_11,AMP(55))
      CALL FFV1P0_3(W(1,1),W(1,9),GC_11,ZERO, FK_ZERO,W(1,18))
...
C     Amplitude(s) for diagram number 51
      ...
      CALL FFV1_1(W(1,9),W(1,5),GC_11,ZERO, FK_ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 57
      ...
      CALL FFV1_1(W(1,9),W(1,4),GC_11,ZERO, FK_ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 63
      ...
      CALL VVVV1P0_1(W(1,4),W(1,5),W(1,6),GC_12,ZERO, FK_ZERO,W(1,13))
      CALL VVVV3P0_1(W(1,4),W(1,5),W(1,6),GC_12,ZERO, FK_ZERO,W(1,7))
      CALL VVVV4P0_1(W(1,4),W(1,5),W(1,6),GC_12,ZERO, FK_ZERO,W(1,21))
C     Amplitude(s) for diagram number 64
      ...
      CALL FFV1_2(W(1,9),W(1,6),GC_11,ZERO, FK_ZERO,W(1,18))
...
C     Amplitude(s) for diagram number 67
      ...
      CALL FFV1_2(W(1,9),W(1,5),GC_11,ZERO, FK_ZERO,W(1,23))
...
C     Amplitude(s) for diagram number 73
      ...
      CALL FFV1_2(W(1,9),W(1,4),GC_11,ZERO, FK_ZERO,W(1,24))
...
C     Amplitude(s) for diagram number 80
      ...
      CALL VVV1P0_1(W(1,3),W(1,20),GC_10,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 81
      CALL FFV1_0(W(1,1),W(1,16),W(1,9),GC_11,AMP(91))
      CALL FFV1_1(W(1,16),W(1,3),GC_11,ZERO, FK_ZERO,W(1,23))
...
C     Amplitude(s) for diagram number 83
      ...
      CALL FFV1_2(W(1,14),W(1,3),GC_11,ZERO, FK_ZERO,W(1,24))
...
C     Amplitude(s) for diagram number 90
      ...
      CALL FFV1_2(W(1,15),W(1,3),GC_11,ZERO, FK_ZERO,W(1,22))
...
C     Amplitude(s) for diagram number 94
      ...
      CALL FFV1_1(W(1,10),W(1,3),GC_11,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 95
      CALL FFV1_0(W(1,1),W(1,17),W(1,8),GC_11,AMP(109))
      CALL VVV1P0_1(W(1,3),W(1,8),GC_10,ZERO, FK_ZERO,W(1,20))
...
C     Amplitude(s) for diagram number 100
      ...
      CALL FFV1_2(W(1,19),W(1,3),GC_11,ZERO, FK_ZERO,W(1,17))
...
C     Amplitude(s) for diagram number 113
      ...
      CALL VVVV1P0_1(W(1,3),W(1,4),W(1,5),GC_12,ZERO, FK_ZERO,W(1,23))
      CALL VVVV3P0_1(W(1,3),W(1,4),W(1,5),GC_12,ZERO, FK_ZERO,W(1,22))
      CALL VVVV4P0_1(W(1,3),W(1,4),W(1,5),GC_12,ZERO, FK_ZERO,W(1,24))
...
C     Amplitude(s) for diagram number 116
      ...
      CALL VVVV1P0_1(W(1,3),W(1,4),W(1,6),GC_12,ZERO, FK_ZERO,W(1,24))
      CALL VVVV3P0_1(W(1,3),W(1,4),W(1,6),GC_12,ZERO, FK_ZERO,W(1,22))
      CALL VVVV4P0_1(W(1,3),W(1,4),W(1,6),GC_12,ZERO, FK_ZERO,W(1,23))
...
C     Amplitude(s) for diagram number 119
      ...
      CALL VVVV1P0_1(W(1,3),W(1,5),W(1,6),GC_12,ZERO, FK_ZERO,W(1,23))
      CALL VVVV3P0_1(W(1,3),W(1,5),W(1,6),GC_12,ZERO, FK_ZERO,W(1,22))
      CALL VVVV4P0_1(W(1,3),W(1,5),W(1,6),GC_12,ZERO, FK_ZERO,W(1,24))
