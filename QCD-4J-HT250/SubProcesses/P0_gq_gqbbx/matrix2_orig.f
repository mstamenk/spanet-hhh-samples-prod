...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1_2(W(1,4),W(1,3),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,7),W(1,10),W(1,9),GC_11,AMP(6))
      CALL FFV1_1(W(1,5),W(1,3),GC_11,MDL_MB, FK_ZERO,W(1,11))
      CALL FFV1P0_3(W(1,4),W(1,10),GC_11,ZERO, FK_ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,4),W(1,14),W(1,9),GC_11,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL VVV1_0(W(1,3),W(1,9),W(1,12),GC_10,AMP(10))
      CALL FFV1_2(W(1,4),W(1,1),GC_11,ZERO, FK_ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,4),W(1,14),W(1,15),GC_11,AMP(16))
...
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,4),W(1,14),W(1,12),GC_11,AMP(21))
...
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,4),W(1,12),W(1,9),GC_11,AMP(26))
      CALL VVV1P0_1(W(1,1),W(1,9),GC_10,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,4),W(1,14),W(1,12),GC_11,AMP(27))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -1.000000000000000D+00)) * AMP(10)  ! used 2 times
      JAMP(1,1) = (-1.666666666666667D-01)*AMP(7)+(-1.666666666666667D
     ...
     $ +(-5.000000000000000D-01)*TMP_JAMP(4)+(-5.000000000000000D-01)
     $ *TMP_JAMP(6)
      JAMP(3,1) = (-1.666666666666667D-01)*AMP(6)+((0.000000000000000D
     ...
     $ *TMP_JAMP(2)+(5.000000000000000D-01)*TMP_JAMP(6)
