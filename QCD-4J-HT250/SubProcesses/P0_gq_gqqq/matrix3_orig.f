...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,2),W(1,14),W(1,9),GC_11,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL VVV1_0(W(1,3),W(1,9),W(1,11),GC_10,AMP(10))
      CALL FFV1_1(W(1,5),W(1,1),GC_11,ZERO, FK_ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,12),W(1,4),W(1,10),GC_11,AMP(12))
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV1_2(W(1,2),W(1,1),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,10),W(1,14),W(1,9),GC_11,AMP(16))
      CALL FFV1P0_3(W(1,10),W(1,4),GC_11,ZERO, FK_ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,11),W(1,4),W(1,9),GC_11,AMP(19))
...
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,2),W(1,14),W(1,11),GC_11,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,15),W(1,7),W(1,8),GC_11,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,12),W(1,4),W(1,11),GC_11,AMP(23))
...
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,2),W(1,11),W(1,9),GC_11,AMP(26))
      CALL VVV1P0_1(W(1,1),W(1,9),GC_10,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,2),W(1,14),W(1,11),GC_11,AMP(27))
...
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,7),W(1,4),W(1,9),GC_11,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,12),W(1,4),W(1,11),GC_11,AMP(31))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ ,1.000000000000000D+00)) * AMP(9)  ! used 2 times
      JAMP(1,1) = (1.666666666666667D-01)*AMP(7)+((0.000000000000000D
     $ +00,-1.666666666666667D-01))*TMP_JAMP(4)+((0.000000000000000D
     $ +00,-1.666666666666667D-01))*TMP_JAMP(5)
      JAMP(2,1) = (-5.000000000000000D-01)*AMP(8)+((0.000000000000000D
     ...
     $ ,5.000000000000000D-01))*TMP_JAMP(6)+(-5.000000000000000D-01)
     $ *TMP_JAMP(9)
      JAMP(4,1) = (1.666666666666667D-01)*AMP(13)+((0.000000000000000D
     ...
     $ *TMP_JAMP(8)+(5.000000000000000D-01)*TMP_JAMP(9)
     ...
     $ +((0.000000000000000D+00,1.666666666666667D-01))*TMP_JAMP(11)
      JAMP(10,1) = (-5.000000000000000D-01)*AMP(21)+(
     ...
     $ -5.000000000000000D-01))*TMP_JAMP(13)
      JAMP(11,1) = (-5.000000000000000D-01)*AMP(17)+(
     ...
     $ -5.000000000000000D-01))*TMP_JAMP(15)
      JAMP(12,1) = (1.666666666666667D-01)*AMP(22)+(1.666666666666667D
