...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1P0_3(W(1,6),W(1,2),GC_11,ZERO, FK_ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_1(W(1,2),W(1,7),GC_11,ZERO, FK_ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1_1(W(1,4),W(1,3),GC_11,ZERO, FK_ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 42
      ...
      CALL FFV1P0_3(W(1,9),W(1,2),GC_11,ZERO, FK_ZERO,W(1,18))
...
C     Amplitude(s) for diagram number 67
      CALL VVVV1_0(W(1,1),W(1,3),W(1,8),W(1,11),GC_12,AMP(67))
      CALL VVVV3_0(W(1,1),W(1,3),W(1,8),W(1,11),GC_12,AMP(68))
      CALL VVVV4_0(W(1,1),W(1,3),W(1,8),W(1,11),GC_12,AMP(69))
C     Amplitude(s) for diagram number 68
      CALL VVV1_0(W(1,3),W(1,11),W(1,10),GC_10,AMP(70))
C     Amplitude(s) for diagram number 69
      CALL VVV1_0(W(1,3),W(1,8),W(1,18),GC_10,AMP(71))
C     Amplitude(s) for diagram number 70
      CALL VVVV1_0(W(1,1),W(1,3),W(1,12),W(1,13),GC_12,AMP(72))
      CALL VVVV3_0(W(1,1),W(1,3),W(1,12),W(1,13),GC_12,AMP(73))
      CALL VVVV4_0(W(1,1),W(1,3),W(1,12),W(1,13),GC_12,AMP(74))
C     Amplitude(s) for diagram number 71
      CALL VVV1_0(W(1,3),W(1,13),W(1,17),GC_10,AMP(75))
C     Amplitude(s) for diagram number 72
      CALL VVV1_0(W(1,3),W(1,12),W(1,7),GC_10,AMP(76))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(6) = AMP(69) +  AMP(71)  ! used 4 times
      TMP_JAMP(5) = AMP(3) +  AMP(67)  ! used 4 times
      TMP_JAMP(4) = AMP(74) +  AMP(76)  ! used 4 times
      TMP_JAMP(3) = AMP(6) +  AMP(72)  ! used 4 times
      TMP_JAMP(2) = AMP(68) +  AMP(70)  ! used 4 times
      TMP_JAMP(1) = AMP(73) +  AMP(75)  ! used 4 times
      TMP_JAMP(32) = AMP(8) + (3.000000000000000D+00) * AMP(9)  ! used 2 times
      TMP_JAMP(31) = AMP(2) + (3.333333333333333D-01) * AMP(7)  ! used 2 times
      ...
      TMP_JAMP(26) = AMP(5) + (3.000000000000000D+00) * AMP(10)  ! used 2 times
      TMP_JAMP(25) = AMP(1) + (3.333333333333333D-01) * AMP(4)  ! used 2 times
      TMP_JAMP(24) = TMP_JAMP(5) +  TMP_JAMP(2)  ! used 2 times
      TMP_JAMP(23) = AMP(4) +  AMP(8)  ! used 2 times
      TMP_JAMP(22) = AMP(1) +  AMP(2)  ! used 2 times
      ...
      TMP_JAMP(18) = AMP(8) + ((-0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(65)  ! used 2 times
      TMP_JAMP(17) = AMP(4) + ((-0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(29)  ! used 2 times
      TMP_JAMP(16) = AMP(2) + ((-0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(63)  ! used 2 times
      TMP_JAMP(15) = AMP(1) + ((-0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(27)  ! used 2 times
      TMP_JAMP(14) = TMP_JAMP(4) + ((0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(66)  ! used 2 times
      TMP_JAMP(13) = AMP(10) + ((0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(61)  ! used 2 times
      TMP_JAMP(12) = AMP(5) + ((0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(59)  ! used 2 times
      TMP_JAMP(11) = TMP_JAMP(6) + ((-0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(62)  ! used 2 times
      TMP_JAMP(10) = AMP(9) + ((0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(19)  ! used 2 times
      TMP_JAMP(9) = AMP(7) + ((0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(17)  ! used 2 times
      TMP_JAMP(8) = TMP_JAMP(2) + ((-0.000000000000000D+00,
     ...
     $ -1.000000000000000D+00)) * AMP(18)  ! used 2 times
      JAMP(1,1) = (1.666666666666667D-01)*AMP(11)+(5.000000000000000D
     ...
     $ *TMP_JAMP(7)+(-5.000000000000000D-01)*TMP_JAMP(14)
      JAMP(2,1) = (-5.000000000000000D-01)*AMP(11)+(
     ...
     $ *TMP_JAMP(11)
      JAMP(3,1) = (5.000000000000000D-01)*AMP(13)+(1.666666666666667D
     $ -01)*AMP(14)+((0.000000000000000D+00,5.000000000000000D-01))
     $ *AMP(60)+(5.000000000000000D-01)*TMP_JAMP(3)
     $ +(5.000000000000000D-01)*TMP_JAMP(7)+((0.000000000000000D+00,
     $ -5.000000000000000D-01))*TMP_JAMP(9)+((0.000000000000000D+00,
     $ -1.666666666666667D-01))*TMP_JAMP(10)+((0.000000000000000D+00,
     $ -5.000000000000000D-01))*TMP_JAMP(12)+((0.000000000000000D+00,
     $ -1.666666666666667D-01))*TMP_JAMP(13)
      JAMP(4,1) = (-5.000000000000000D-01)*AMP(15)+(
     ...
     $ +((0.000000000000000D+00,1.666666666666667D-01))*TMP_JAMP(18)
      JAMP(5,1) = (-5.000000000000000D-01)*AMP(23)+(
     $ -1.666666666666667D-01)*AMP(24)+((0.000000000000000D+00
     $ ,5.000000000000000D-01))*AMP(28)+(5.000000000000000D-01)
     $ *TMP_JAMP(5)+(-5.000000000000000D-01)*TMP_JAMP(11)
     ...
     $ +((0.000000000000000D+00,1.666666666666667D-01))*TMP_JAMP(17)
      JAMP(6,1) = (5.000000000000000D-01)*AMP(25)+(1.666666666666667D
     $ -01)*AMP(26)+((0.000000000000000D+00,-5.000000000000000D-01))
     $ *AMP(30)+(-5.000000000000000D-01)*TMP_JAMP(3)
     $ +(5.000000000000000D-01)*TMP_JAMP(14)+((0.000000000000000D+00,
     $ -1.666666666666667D-01))*TMP_JAMP(15)+((0.000000000000000D+00,
     $ -1.666666666666667D-01))*TMP_JAMP(16)+((0.000000000000000D+00,
     $ -5.000000000000000D-01))*TMP_JAMP(17)+((0.000000000000000D+00,
     ...
     $ *TMP_JAMP(20)
      JAMP(9,1) = (5.000000000000000D-01)*AMP(43)+(1.666666666666667D
     ...
     $ -5.000000000000000D-01))*AMP(58)+(5.000000000000000D-01)
     $ *TMP_JAMP(21)+((0.000000000000000D+00,1.666666666666667D-01))
     $ *TMP_JAMP(22)+((0.000000000000000D+00,5.000000000000000D-01))
     $ *TMP_JAMP(23)
      JAMP(10,1) = (-5.000000000000000D-01)*AMP(33)+(
     ...
     $ *TMP_JAMP(26)
      JAMP(11,1) = (5.000000000000000D-01)*AMP(31)+(1.666666666666667D
     ...
     $ *TMP_JAMP(29)
      JAMP(12,1) = (-5.000000000000000D-01)*AMP(41)+(
     ...
     $ *TMP_JAMP(30)+((0.000000000000000D+00,-5.000000000000000D-01))
     $ *TMP_JAMP(31)+((0.000000000000000D+00,-1.666666666666667D-01))
     $ *TMP_JAMP(32)
