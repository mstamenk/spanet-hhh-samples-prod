...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1_2(W(1,4),W(1,8),GC_11,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,13),W(1,1),W(1,11),GC_11,AMP(11))
      CALL FFV1_2(W(1,4),W(1,11),GC_11,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,13),W(1,1),W(1,8),GC_11,AMP(12))
      CALL FFV1_2(W(1,4),W(1,12),GC_11,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,13),W(1,1),W(1,10),GC_11,AMP(13))
      CALL FFV1_2(W(1,4),W(1,10),GC_11,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,13),W(1,1),W(1,12),GC_11,AMP(14))
