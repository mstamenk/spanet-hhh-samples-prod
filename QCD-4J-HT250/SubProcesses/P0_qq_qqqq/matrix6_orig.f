...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      TMP_JAMP(9) = AMP(5) +  AMP(8)  ! used 3 times
      TMP_JAMP(8) = AMP(1) +  AMP(2)  ! used 3 times
      TMP_JAMP(7) = AMP(13) +  AMP(14)  ! used 3 times
      TMP_JAMP(6) = AMP(4) +  AMP(5)  ! used 3 times
      TMP_JAMP(5) = AMP(2) +  AMP(10)  ! used 3 times
      TMP_JAMP(4) = AMP(7) +  AMP(8)  ! used 3 times
      TMP_JAMP(3) = AMP(1) +  AMP(9)  ! used 3 times
     ...
     $ *AMP(3)+(2.500000000000000D-01)*AMP(11)+(2.500000000000000D-01)
     ...
     $ -02)*TMP_JAMP(8)+(-8.333333333333333D-02)*TMP_JAMP(14)
