...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
      ...
      CALL FFV1P0_3(W(1,6),W(1,4),GC_11,ZERO, FK_ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1P0_3(W(1,2),W(1,5),GC_11,ZERO, FK_ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,6),W(1,10),W(1,9),GC_11,AMP(5))
...
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,2),W(1,11),W(1,7),GC_11,AMP(6))
...
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,6),W(1,11),W(1,9),GC_11,AMP(10))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(10) = AMP(11) +  AMP(12)  ! used 3 times
      TMP_JAMP(9) = AMP(6) +  AMP(7)  ! used 3 times
      TMP_JAMP(8) = AMP(1) +  AMP(4)  ! used 3 times
      TMP_JAMP(7) = AMP(13) +  AMP(14)  ! used 3 times
      TMP_JAMP(6) = AMP(9) +  AMP(10)  ! used 3 times
      TMP_JAMP(5) = AMP(7) +  AMP(10)  ! used 3 times
      TMP_JAMP(4) = AMP(6) +  AMP(9)  ! used 3 times
      TMP_JAMP(3) = AMP(4) +  AMP(5)  ! used 3 times
      TMP_JAMP(2) = AMP(1) +  AMP(2)  ! used 3 times
      TMP_JAMP(1) = AMP(2) +  AMP(5)  ! used 3 times
     ...
     $ *AMP(8)+(2.500000000000000D-01)*AMP(11)+(2.500000000000000D-01)
     $ *TMP_JAMP(5)+(8.333333333333333D-02)*TMP_JAMP(11)
      JAMP(2,1) = (-8.333333333333333D-02)*TMP_JAMP(6)+(
     $ -2.777777777777778D-02)*TMP_JAMP(7)+(-8.333333333333333D-02)
     $ *TMP_JAMP(10)+(-2.777777777777778D-02)*TMP_JAMP(11)
      JAMP(3,1) = ((0.000000000000000D+00,-2.500000000000000D-01))
     $ *AMP(3)+(-2.500000000000000D-01)*AMP(13)+(-2.500000000000000D
     $ -01)*TMP_JAMP(1)+(-8.333333333333333D-02)*TMP_JAMP(12)
      JAMP(4,1) = ((0.000000000000000D+00,-2.500000000000000D-01))
     $ *AMP(8)+(2.500000000000000D-01)*AMP(12)+(8.333333333333333D-02)
     $ *TMP_JAMP(2)+(2.500000000000000D-01)*TMP_JAMP(4)
