...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,6),W(1,3),W(1,11),GC_11,AMP(9))
...
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,13),W(1,2),W(1,10),GC_11,AMP(13))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ *AMP(6)+(2.500000000000000D-01)*AMP(14)+(2.500000000000000D-01)
     ...
     $ *AMP(6)+(2.500000000000000D-01)*AMP(13)+(8.333333333333333D-02)
