...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,10),W(1,4),W(1,9),GC_11,AMP(4))
      CALL FFV1_1(W(1,4),W(1,7),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,2),W(1,10),W(1,9),GC_11,AMP(5))
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11,ZERO, FK_ZERO,W(1,10))
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11,ZERO, FK_ZERO,W(1,7))
      CALL FFV1_1(W(1,5),W(1,10),GC_11,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,6),W(1,11),W(1,7),GC_11,AMP(6))
      CALL FFV1_2(W(1,6),W(1,10),GC_11,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,11),W(1,5),W(1,7),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL VVV1_0(W(1,10),W(1,7),W(1,9),GC_10,AMP(8))
      CALL FFV1_2(W(1,2),W(1,10),GC_11,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,11),W(1,3),W(1,9),GC_11,AMP(9))
      CALL FFV1_1(W(1,3),W(1,10),GC_11,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,2),W(1,11),W(1,9),GC_11,AMP(10))
      CALL FFV1_2(W(1,1),W(1,7),GC_11,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,11),W(1,4),W(1,9),GC_11,AMP(11))
      CALL FFV1_2(W(1,1),W(1,9),GC_11,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,11),W(1,4),W(1,7),GC_11,AMP(12))
      CALL FFV1_2(W(1,1),W(1,8),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,7),W(1,3),W(1,9),GC_11,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,11),W(1,3),W(1,8),GC_11,AMP(14))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(12) = AMP(13) +  AMP(14)  ! used 3 times
      TMP_JAMP(11) = AMP(9) +  AMP(12)  ! used 3 times
      TMP_JAMP(10) = AMP(6) +  AMP(12)  ! used 3 times
      TMP_JAMP(9) = AMP(6) +  AMP(9)  ! used 3 times
      TMP_JAMP(8) = AMP(1) +  AMP(2)  ! used 3 times
      TMP_JAMP(7) = AMP(9) +  AMP(10)  ! used 3 times
      TMP_JAMP(6) = AMP(6) +  AMP(7)  ! used 3 times
      TMP_JAMP(5) = AMP(2) +  AMP(5)  ! used 3 times
      TMP_JAMP(4) = AMP(7) +  AMP(11)  ! used 3 times
      TMP_JAMP(3) = AMP(1) +  AMP(4)  ! used 3 times
      TMP_JAMP(2) = AMP(10) +  AMP(11)  ! used 3 times
      TMP_JAMP(1) = AMP(4) +  AMP(5)  ! used 3 times
      ...
      TMP_JAMP(13) = TMP_JAMP(8) + (3.000000000000000D+00) *
     $  TMP_JAMP(2)  ! used 2 times
      JAMP(1,1) = (8.333333333333333D-02)*TMP_JAMP(11)
     $ +(2.777777777777778D-02)*TMP_JAMP(13)+(2.777777777777778D-02)
     $ *TMP_JAMP(14)
      JAMP(2,1) = (-2.500000000000000D-01)*AMP(7)+((0.000000000000000D
     $ +00,-2.500000000000000D-01))*AMP(8)+(-8.333333333333333D-02)
     $ *TMP_JAMP(1)+(-8.333333333333333D-02)*TMP_JAMP(13)
      JAMP(3,1) = (-2.777777777777778D-02)*TMP_JAMP(6)+(
     $ -8.333333333333333D-02)*TMP_JAMP(14)+(-2.777777777777778D-02)
     $ *TMP_JAMP(15)
      JAMP(4,1) = ((0.000000000000000D+00,-2.500000000000000D-01))
     $ *AMP(3)+(2.500000000000000D-01)*AMP(14)+(2.500000000000000D-01)
     $ *TMP_JAMP(3)+(8.333333333333333D-02)*TMP_JAMP(4)
     $ +(8.333333333333333D-02)*TMP_JAMP(10)
