...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1_2(W(1,6),W(1,7),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,2),W(1,4),W(1,9),GC_11,AMP(4))
      CALL FFV1_1(W(1,4),W(1,7),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,6),W(1,2),W(1,9),GC_11,AMP(5))
      CALL FFV1_2(W(1,5),W(1,8),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,2),W(1,3),W(1,9),GC_11,AMP(6))
      CALL FFV1_2(W(1,5),W(1,9),GC_11,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,2),W(1,3),W(1,8),GC_11,AMP(7))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(5) = AMP(4) +  AMP(5)  ! used 3 times
      TMP_JAMP(4) = AMP(1) +  AMP(2)  ! used 3 times
      TMP_JAMP(3) = AMP(2) +  AMP(6)  ! used 3 times
      TMP_JAMP(2) = AMP(1) +  AMP(7)  ! used 3 times
      TMP_JAMP(1) = AMP(6) +  AMP(7)  ! used 3 times
      ...
      JAMP(1,1) = (-2.777777777777778D-02)*TMP_JAMP(4)+(
     ...
     $ *AMP(3)+(-2.500000000000000D-01)*AMP(4)+(-2.500000000000000D-01)
     $ *TMP_JAMP(2)
      JAMP(5,1) = ((0.000000000000000D+00,-2.500000000000000D-01))
     $ *AMP(3)+(-2.500000000000000D-01)*AMP(5)+(-2.500000000000000D-01)
     $ *TMP_JAMP(3)
