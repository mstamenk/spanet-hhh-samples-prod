...
C     Continue only if IMODE is 0, 4 or 5
      ...
      PD(IPROC)=C1*C2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! d d > d u d u~
      PD(IPROC)=D1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! d d > d c d c~
      PD(IPROC)=D1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! d d > d d s s~
      PD(IPROC)=D1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! s s > s u s u~
      PD(IPROC)=S1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! s s > s c s c~
      PD(IPROC)=S1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! s s > s d s d~
      PD(IPROC)=S1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IF (IMODE.EQ.4)THEN
        DSIG4 = PD(0)
