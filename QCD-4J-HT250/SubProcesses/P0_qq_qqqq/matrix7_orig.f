...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,10),W(1,3),W(1,9),GC_11,AMP(4))
      CALL FFV1_1(W(1,3),W(1,7),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,5),W(1,10),W(1,9),GC_11,AMP(5))
      CALL FFV1P0_3(W(1,1),W(1,3),GC_11,ZERO, FK_ZERO,W(1,10))
      CALL FFV1P0_3(W(1,5),W(1,2),GC_11,ZERO, FK_ZERO,W(1,7))
      CALL FFV1_1(W(1,4),W(1,10),GC_11,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,6),W(1,11),W(1,7),GC_11,AMP(6))
      CALL FFV1_2(W(1,6),W(1,10),GC_11,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,11),W(1,4),W(1,7),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL VVV1_0(W(1,10),W(1,7),W(1,9),GC_10,AMP(8))
      CALL FFV1_2(W(1,5),W(1,10),GC_11,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,11),W(1,2),W(1,9),GC_11,AMP(9))
      CALL FFV1_1(W(1,2),W(1,10),GC_11,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,5),W(1,11),W(1,9),GC_11,AMP(10))
      CALL FFV1_2(W(1,1),W(1,7),GC_11,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,11),W(1,3),W(1,9),GC_11,AMP(11))
      CALL FFV1_2(W(1,1),W(1,9),GC_11,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,11),W(1,3),W(1,7),GC_11,AMP(12))
      CALL FFV1_2(W(1,1),W(1,8),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,7),W(1,2),W(1,9),GC_11,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,11),W(1,2),W(1,8),GC_11,AMP(14))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ *AMP(3)+(-2.500000000000000D-01)*AMP(14)+(-2.500000000000000D
     $ -01)*TMP_JAMP(3)+(-8.333333333333333D-02)*TMP_JAMP(4)+(
     $ -8.333333333333333D-02)*TMP_JAMP(10)
      JAMP(5,1) = ((0.000000000000000D+00,-2.500000000000000D-01))
     $ *AMP(3)+(-2.500000000000000D-01)*AMP(13)+(-2.500000000000000D
     ...
     $ *AMP(8)+(2.500000000000000D-01)*AMP(12)+(2.500000000000000D-01)
     $ *TMP_JAMP(9)+(8.333333333333333D-02)*TMP_JAMP(16)
