...
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,11),W(1,2),W(1,7),GC_11,AMP(7))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(11) = AMP(9) +  AMP(10)  ! used 3 times
      TMP_JAMP(10) = AMP(6) +  AMP(7)  ! used 3 times
      TMP_JAMP(9) = AMP(2) +  AMP(5)  ! used 3 times
      TMP_JAMP(8) = AMP(13) +  AMP(14)  ! used 3 times
      TMP_JAMP(7) = AMP(9) +  AMP(12)  ! used 3 times
      TMP_JAMP(6) = AMP(6) +  AMP(12)  ! used 3 times
      TMP_JAMP(5) = AMP(1) +  AMP(2)  ! used 3 times
      TMP_JAMP(4) = AMP(10) +  AMP(11)  ! used 3 times
      TMP_JAMP(3) = AMP(7) +  AMP(11)  ! used 3 times
      TMP_JAMP(2) = AMP(4) +  AMP(5)  ! used 3 times
      TMP_JAMP(1) = AMP(1) +  AMP(4)  ! used 3 times
     ...
     $ *AMP(8)+(2.500000000000000D-01)*AMP(10)+(2.500000000000000D-01)
     $ *TMP_JAMP(3)+(8.333333333333333D-02)*TMP_JAMP(12)
      JAMP(2,1) = (-8.333333333333333D-02)*TMP_JAMP(4)+(
     $ -8.333333333333333D-02)*TMP_JAMP(7)+(-2.777777777777778D-02)
     $ *TMP_JAMP(8)+(-2.777777777777778D-02)*TMP_JAMP(12)
      JAMP(3,1) = ((0.000000000000000D+00,2.500000000000000D-01))
     $ *AMP(3)+(-2.500000000000000D-01)*AMP(14)+(-2.500000000000000D
     $ -01)*TMP_JAMP(1)+(-8.333333333333333D-02)*TMP_JAMP(13)
      JAMP(4,1) = (8.333333333333333D-02)*TMP_JAMP(2)
     $ +(8.333333333333333D-02)*TMP_JAMP(8)+(2.777777777777778D-02)
     $ *TMP_JAMP(11)+(2.777777777777778D-02)*TMP_JAMP(13)
      JAMP(5,1) = ((0.000000000000000D+00,-2.500000000000000D-01))
     $ *AMP(8)+(2.500000000000000D-01)*AMP(9)+(8.333333333333333D-02)
     $ *TMP_JAMP(5)+(2.500000000000000D-01)*TMP_JAMP(6)
     $ +(8.333333333333333D-02)*TMP_JAMP(8)
     ...
     $ -8.333333333333333D-02)*TMP_JAMP(11)
