...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11,ZERO, FK_ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_2(W(1,1),W(1,7),GC_11,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,6),W(1,4),W(1,10),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,1),W(1,9),W(1,10),GC_11,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,6),W(1,2),W(1,11),GC_11,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,1),W(1,13),W(1,11),GC_11,AMP(10))
      CALL FFV1_2(W(1,5),W(1,8),GC_11,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,13),W(1,3),W(1,11),GC_11,AMP(11))
      CALL FFV1_2(W(1,5),W(1,11),GC_11,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,13),W(1,3),W(1,8),GC_11,AMP(12))
      CALL FFV1_2(W(1,5),W(1,12),GC_11,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,13),W(1,3),W(1,10),GC_11,AMP(13))
      CALL FFV1_2(W(1,5),W(1,10),GC_11,ZERO, FK_ZERO,W(1,13))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      TMP_JAMP(9) = AMP(9) +  AMP(10)  ! used 3 times
      TMP_JAMP(8) = AMP(7) +  AMP(8)  ! used 3 times
      TMP_JAMP(7) = AMP(5) +  AMP(8)  ! used 3 times
      TMP_JAMP(6) = AMP(4) +  AMP(7)  ! used 3 times
      TMP_JAMP(5) = AMP(4) +  AMP(5)  ! used 3 times
      TMP_JAMP(4) = AMP(1) +  AMP(2)  ! used 3 times
      TMP_JAMP(3) = AMP(1) +  AMP(12)  ! used 3 times
      TMP_JAMP(2) = AMP(2) +  AMP(11)  ! used 3 times
      TMP_JAMP(1) = AMP(11) +  AMP(12)  ! used 3 times
      ...
      JAMP(1,1) = (-2.777777777777778D-02)*TMP_JAMP(9)+(
     ...
     $ *TMP_JAMP(7)+(8.333333333333333D-02)*TMP_JAMP(11)
      JAMP(3,1) = ((0.000000000000000D+00,-2.500000000000000D-01))
     $ *AMP(6)+(2.500000000000000D-01)*AMP(14)+(2.500000000000000D-01)
     $ *TMP_JAMP(6)+(8.333333333333333D-02)*TMP_JAMP(12)
      JAMP(4,1) = ((0.000000000000000D+00,-2.500000000000000D-01))
     $ *AMP(3)+(-2.500000000000000D-01)*AMP(10)+(-2.500000000000000D
     $ -01)*TMP_JAMP(2)+(-8.333333333333333D-02)*TMP_JAMP(14)
      JAMP(5,1) = ((0.000000000000000D+00,2.500000000000000D-01))
     $ *AMP(3)+(-2.500000000000000D-01)*AMP(9)+(-2.500000000000000D-01)
     $ *TMP_JAMP(3)+(-8.333333333333333D-02)*TMP_JAMP(13)
