...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1P0_3(W(1,5),W(1,4),GC_11,ZERO, FK_ZERO,W(1,12))
      CALL FFV1_1(W(1,3),W(1,7),GC_11,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,6),W(1,13),W(1,12),GC_11,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,10),W(1,3),W(1,12),GC_11,AMP(5))
      CALL FFV1P0_3(W(1,6),W(1,3),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 6
      CALL VVV1_0(W(1,7),W(1,12),W(1,10),GC_10,AMP(6))
      CALL FFV1_2(W(1,5),W(1,7),GC_11,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,14),W(1,4),W(1,10),GC_11,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,5),W(1,9),W(1,10),GC_11,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,14),W(1,3),W(1,11),GC_11,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,5),W(1,13),W(1,11),GC_11,AMP(10))
      CALL FFV1P0_3(W(1,1),W(1,3),GC_11,ZERO, FK_ZERO,W(1,13))
      CALL FFV1P0_3(W(1,5),W(1,2),GC_11,ZERO, FK_ZERO,W(1,14))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ *AMP(16)+((0.000000000000000D+00,-2.500000000000000D-01))
     $ *AMP(23)+(-2.777777777777778D-02)*TMP_JAMP(40)+(
     $ -2.777777777777778D-02)*TMP_JAMP(42)+(-8.333333333333333D-02)
     $ *TMP_JAMP(43)+(-8.333333333333333D-02)*TMP_JAMP(50)+(
     $ -2.500000000000000D-01)*TMP_JAMP(52)
      JAMP(2,1) = ((0.000000000000000D+00,2.500000000000000D-01))
     $ *AMP(13)+((0.000000000000000D+00,-2.500000000000000D-01))
     $ *AMP(26)+(8.333333333333333D-02)*TMP_JAMP(2)
     $ +(2.500000000000000D-01)*TMP_JAMP(12)+(8.333333333333333D-02)
     $ *TMP_JAMP(15)+(8.333333333333333D-02)*TMP_JAMP(19)
     $ +(2.777777777777778D-02)*TMP_JAMP(20)+(2.500000000000000D-01)
     $ *TMP_JAMP(30)+(8.333333333333333D-02)*TMP_JAMP(40)
     $ +(8.333333333333333D-02)*TMP_JAMP(52)
     ...
     $ +(-8.333333333333333D-02)*AMP(27)+(-2.500000000000000D-01)
     $ *AMP(38)+(-2.500000000000000D-01)*AMP(39)+(-2.500000000000000D
     $ -01)*TMP_JAMP(5)+(-8.333333333333333D-02)*TMP_JAMP(6)+(
     ...
     $ +(-2.500000000000000D-01)*AMP(29)+(-8.333333333333333D-02)
     $ *AMP(35)+(-2.500000000000000D-01)*AMP(37)+(-2.500000000000000D
     $ -01)*TMP_JAMP(9)+(-8.333333333333333D-02)*TMP_JAMP(10)+(
