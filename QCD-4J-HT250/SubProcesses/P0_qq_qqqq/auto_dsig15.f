...
C     Continue only if IMODE is 0, 4 or 5
      ...
      PD(0) = 0D0
      IPROC = 0
      IPROC=IPROC+1  ! u c > u c d d~
      PD(IPROC)=U1*C2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! u c > u c s s~
      PD(IPROC)=U1*C2
      PD(0)=PD(0)+DABS(PD(IPROC))
      ...
      PD(IPROC)=U1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! u s > u s c c~
      PD(IPROC)=U1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! u s > u s d d~
      PD(IPROC)=U1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c d > d u c u~
      PD(IPROC)=C1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c d > c d s s~
      PD(IPROC)=C1*D2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c s > s u c u~
      PD(IPROC)=C1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c s > c s d d~
      PD(IPROC)=C1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! d s > s u d u~
      PD(IPROC)=D1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! d s > s c d c~
      PD(IPROC)=D1*S2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IF (IMODE.EQ.4)THEN
        DSIG15 = PD(0)
