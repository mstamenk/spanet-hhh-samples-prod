...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1_2(W(1,4),W(1,2),GC_11,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,7),W(1,10),W(1,9),GC_11,AMP(6))
      CALL FFV1_1(W(1,5),W(1,2),GC_11,MDL_MB, FK_ZERO,W(1,11))
      CALL FFV1P0_3(W(1,4),W(1,10),GC_11,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,6),W(1,11),W(1,12),GC_11,AMP(7))
      CALL FFV1_2(W(1,6),W(1,2),GC_11,MDL_MB, FK_ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 10
      CALL VVV1_0(W(1,2),W(1,9),W(1,12),GC_10,AMP(10))
...
C     Amplitude(s) for diagram number 11
      ...
      CALL FFV1P0_3(W(1,12),W(1,3),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,6),W(1,11),W(1,10),GC_11,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,13),W(1,5),W(1,10),GC_11,AMP(13))
      CALL FFV1_2(W(1,12),W(1,2),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,15),W(1,3),W(1,9),GC_11,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL VVV1_0(W(1,2),W(1,9),W(1,10),GC_10,AMP(15))
...
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,7),W(1,3),W(1,15),GC_11,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,13),W(1,10),W(1,8),GC_11,AMP(18))
      CALL FFV1_1(W(1,10),W(1,2),GC_11,MDL_MB, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,6),W(1,12),W(1,8),GC_11,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL VVV1_0(W(1,2),W(1,8),W(1,15),GC_10,AMP(20))
...
C     Amplitude(s) for diagram number 23
      ...
      CALL FFV1_2(W(1,15),W(1,2),GC_11,MDL_MB, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,10),W(1,5),W(1,8),GC_11,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL VVV1_0(W(1,2),W(1,8),W(1,12),GC_10,AMP(25))
...
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,14),W(1,3),W(1,9),GC_11,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,7),W(1,3),W(1,12),GC_11,AMP(29))
...
C     Amplitude(s) for diagram number 35
      CALL VVV1_0(W(1,2),W(1,9),W(1,7),GC_10,AMP(37))
C     Amplitude(s) for diagram number 36
      CALL VVV1_0(W(1,2),W(1,8),W(1,12),GC_10,AMP(38))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +00,1.666666666666667D-01))*TMP_JAMP(4)+((0.000000000000000D+00
