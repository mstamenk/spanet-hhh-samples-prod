...
C     
C     Process: u u~ > g g c c~ WEIGHTED<=4
C     Process: u u~ > g g d d~ WEIGHTED<=4
C     Process: u u~ > g g s s~ WEIGHTED<=4
C     Process: c c~ > g g u u~ WEIGHTED<=4
C     Process: c c~ > g g d d~ WEIGHTED<=4
C     Process: c c~ > g g s s~ WEIGHTED<=4
C     Process: d d~ > g g u u~ WEIGHTED<=4
C     Process: d d~ > g g c c~ WEIGHTED<=4
C     Process: d d~ > g g s s~ WEIGHTED<=4
C     Process: s s~ > g g u u~ WEIGHTED<=4
C     Process: s s~ > g g c c~ WEIGHTED<=4
C     Process: s s~ > g g d d~ WEIGHTED<=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), ZERO)
      ...
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11,ZERO,FK_ZERO,W(1,17)) ! count 122
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11,ZERO,FK_ZERO,W(1,18)) ! count 122
     ...
     & TMP, W, AMP(1,2)) ! count 1
      CALL FFV1P0_3(W(1,11),W(1,10),GC_11,ZERO,FK_ZERO,W(1,35)) ! count 122
      CALL FFV1P0_3(W(1,12),W(1,9),GC_11,ZERO,FK_ZERO,W(1,36)) ! count 122
     ...
     & TMP, W, AMP(1,5)) ! count 1
      CALL FFV1_1(W(1,3),W(1,5),GC_11,ZERO,FK_ZERO,W(1,53)) ! count 7
      CALL FFV1_1(W(1,3),W(1,6),GC_11,ZERO,FK_ZERO,W(1,54)) ! count 7
      CALL FFV1_1(W(1,4),W(1,5),GC_11,ZERO,FK_ZERO,W(1,55)) ! count 7
      CALL FFV1_1(W(1,4),W(1,6),GC_11,ZERO,FK_ZERO,W(1,56)) ! count 7
      CALL FFV1_1(W(1,9),W(1,7),GC_11,ZERO,FK_ZERO,W(1,57)) ! count 18
      CALL FFV1_1(W(1,9),W(1,8),GC_11,ZERO,FK_ZERO,W(1,58)) ! count 18
      CALL FFV1_1(W(1,10),W(1,7),GC_11,ZERO,FK_ZERO,W(1,59)) ! count 18
      CALL FFV1_1(W(1,10),W(1,8),GC_11,ZERO,FK_ZERO,W(1,60)) ! count 18
      CALL FFV1P0_3(W(1,1),W(1,55),GC_11,ZERO,FK_ZERO,W(1,61)) ! count 12
      CALL FFV1P0_3(W(1,1),W(1,56),GC_11,ZERO,FK_ZERO,W(1,62)) ! count 12
      CALL FFV1P0_3(W(1,2),W(1,53),GC_11,ZERO,FK_ZERO,W(1,63)) ! count 12
      CALL FFV1P0_3(W(1,2),W(1,54),GC_11,ZERO,FK_ZERO,W(1,64)) ! count 12
     ...
     & TMP, W, AMP(1,10)) ! count 1
      CALL FFV1_1(W(1,9),W(1,5),GC_11,ZERO,FK_ZERO,W(1,81)) ! count 7
      CALL FFV1_1(W(1,9),W(1,6),GC_11,ZERO,FK_ZERO,W(1,82)) ! count 7
      CALL FFV1_1(W(1,10),W(1,5),GC_11,ZERO,FK_ZERO,W(1,83)) ! count 7
      CALL FFV1_1(W(1,10),W(1,6),GC_11,ZERO,FK_ZERO,W(1,84)) ! count 7
      CALL FFV1_1(W(1,3),W(1,7),GC_11,ZERO,FK_ZERO,W(1,85)) ! count 18
      CALL FFV1_1(W(1,3),W(1,8),GC_11,ZERO,FK_ZERO,W(1,86)) ! count 18
      CALL FFV1_1(W(1,4),W(1,7),GC_11,ZERO,FK_ZERO,W(1,87)) ! count 18
      CALL FFV1_1(W(1,4),W(1,8),GC_11,ZERO,FK_ZERO,W(1,88)) ! count 18
     ...
     & TMP, W, AMP(1,16)) ! count 1
      CALL FFV1P0_3(W(1,101),W(1,4),GC_11,ZERO,FK_ZERO,W(1,105)) ! count 12
      CALL FFV1P0_3(W(1,102),W(1,4),GC_11,ZERO,FK_ZERO,W(1,106)) ! count 12
      CALL FFV1P0_3(W(1,103),W(1,3),GC_11,ZERO,FK_ZERO,W(1,107)) ! count 12
      CALL FFV1P0_3(W(1,104),W(1,3),GC_11,ZERO,FK_ZERO,W(1,108)) ! count 12
     ...
     & (/69,70/),
     & TMP, W, AMP(1,18))
      CALL FFV1P1N_1(W(1,10), W(1,106), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,1/), 
     & (/69,70/),
     & TMP, W, AMP(1,18))
      CALL FFV1P1N_1(W(1,10), W(1,107), GC_11, TMP(1))
      call CombineAmp(2,
     & (/15,13/), 
     & (/69,70/),
     & TMP, W, AMP(1,18))
     ...
     & (/71,72/),
     & TMP, W, AMP(1,18))
      CALL FFV1P1N_1(W(1,9), W(1,106), GC_11, TMP(1))
      call CombineAmp(2,
     & (/4,2/), 
     & (/71,72/),
     & TMP, W, AMP(1,18))
      CALL FFV1P1N_1(W(1,9), W(1,107), GC_11, TMP(1))
      call CombineAmp(2,
     & (/16,14/), 
     & (/71,72/),
     & TMP, W, AMP(1,18))
...
C       JAMPs contributing to orders ALL_ORDERS=1
     ...
     $  MP( K,28)+(-5.000000000000000D-01) *TMP_JAMP(6)+(-5.000000000000000D-01)
     ...
     $  *TMP_JAMP(14)
        JAMP(10,1) = (1.666666666666667D-01)*AMP( K,11)+(1.6666666666666
