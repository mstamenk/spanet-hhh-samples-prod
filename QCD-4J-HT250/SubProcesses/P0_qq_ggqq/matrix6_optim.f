...
C     Process: c u~ > g g c u~ WEIGHTED<=4
C     Process: c d~ > g g c d~ WEIGHTED<=4
C     Process: c s~ > g g c s~ WEIGHTED<=4
C     Process: d u~ > g g d u~ WEIGHTED<=4
C     Process: d c~ > g g d c~ WEIGHTED<=4
C     Process: d s~ > g g d s~ WEIGHTED<=4
C     Process: s u~ > g g s u~ WEIGHTED<=4
C     Process: s c~ > g g s c~ WEIGHTED<=4
C     Process: s d~ > g g s d~ WEIGHTED<=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C       JAMPs contributing to orders ALL_ORDERS=1
        ...
        TMP_JAMP(17) = AMP( K,1) +  AMP( K,2)  ! used 2 times
        TMP_JAMP(16) = AMP( K,1) +  AMP( K,5)  ! used 2 times
        TMP_JAMP(15) = TMP_JAMP(3) +  TMP_JAMP(2)  ! used 2 times
        TMP_JAMP(14) = TMP_JAMP(3) +  TMP_JAMP(1)  ! used 2 times
        TMP_JAMP(13) = AMP( K,2) + ((0.000000000000000D+00 ,1.0000000000
     $  00000D+00)) * AMP( K,32)  ! used 2 times
        TMP_JAMP(12) = AMP( K,1) + ((0.000000000000000D+00 ,1.0000000000
     $  00000D+00)) * AMP( K,14)  ! used 2 times
        TMP_JAMP(11) = AMP( K,5) + ((-0.000000000000000D+00 ,1.000000000
     $  000000D+00)) * AMP( K,30)  ! used 2 times
        TMP_JAMP(10) = TMP_JAMP(2) - TMP_JAMP(1)  ! used 2 times
        TMP_JAMP(9) = TMP_JAMP(1) + ((-0.000000000000000D+00, -1.0000000
     $  00000000D+00)) * AMP( K,27)  ! used 2 times
        TMP_JAMP(8) = TMP_JAMP(3) + ((-0.000000000000000D+00 ,1.00000000
     $  0000000D+00)) * AMP( K,33)  ! used 2 times
        TMP_JAMP(7) = AMP( K,4) + ((-0.000000000000000D+00, -1.000000000
     $  000000D+00)) * AMP( K,26)  ! used 2 times
        TMP_JAMP(6) = AMP( K,4) +  AMP( K,5)  ! used 2 times
        TMP_JAMP(5) = AMP( K,4) + ((0.000000000000000D+00 ,1.00000000000
     $  0000D+00)) * AMP( K,9)  ! used 2 times
        TMP_JAMP(4) = TMP_JAMP(2) + ((-0.000000000000000D+00, -1.0000000
     $  00000000D+00)) * AMP( K,2)  ! used 2 times
        JAMP(1,1) = (5.000000000000000D-01)*AMP( K,8)+((0.00000000000000
     $  0D +00,-5.000000000000000D-01))*AMP( K,10)+(5.000000000000000D-01) *AMP(
     $   K,32)+(5.000000000000000D-01)*TMP_JAMP(4) +((0.000000000000000D+00,-5.0
     $  00000000000000D-01))*TMP_JAMP(5) +(5.000000000000000D-01)*TMP_JAMP(8)
        JAMP(2,1) = (5.000000000000000D-01)*AMP( K,21)+(5.00000000000000
     $  0D -01)*AMP( K,24)+((0.000000000000000D+00,5.000000000000000D-01)) *AMP(
     $   K,25)+(-5.000000000000000D-01)*TMP_JAMP(4) +((0.000000000000000D+00,5.0
     $  00000000000000D-01))*TMP_JAMP(7) +(5.000000000000000D-01)*TMP_JAMP(9)
        JAMP(3,1) = (-1.666666666666667D-01)*AMP( K,7)+((0.0000000000000
     $  00D +00,1.666666666666667D-01))*TMP_JAMP(5)+((0.000000000000000D+00 ,1.6
     $  66666666666667D-01))*TMP_JAMP(11)
        JAMP(4,1) = (-1.666666666666667D-01)*AMP( K,16)+( -1.66666666666
     $  6667D-01)*AMP( K,19)+(-1.666666666666667D-01)*AMP( K,26) +((0.0000000000
     $  00000D+00,-1.666666666666667D-01))*TMP_JAMP(6)
        JAMP(5,1) = (5.000000000000000D-01)*AMP( K,11)+(5.00000000000000
     ...
     $  K,18)+((0.000000000000000D+00,-5.000000000000000D-01)) *AMP( K,20)+(-5.0
     $  00000000000000D-01)*TMP_JAMP(8)+( -5.000000000000000D-01)*TMP_JAMP(9)
        JAMP(6,1) = (-1.666666666666667D-01)*AMP( K,11)+( -1.66666666666
     $  6667D-01)*AMP( K,12)+(-1.666666666666667D-01)*AMP( K,21) +(-1.6666666666
     $  66667D-01)*AMP( K,23)
        JAMP(7,1) = (5.000000000000000D-01)*AMP( K,12)+((0.0000000000000
     $  00D +00,-5.000000000000000D-01))*AMP( K,15)+((0.000000000000000D+00 ,5.0
     $  00000000000000D-01))*AMP( K,31)+(-5.000000000000000D-01) *TMP_JAMP(10)+(
     $  (0.000000000000000D+00,-5.000000000000000D-01)) *TMP_JAMP(11)+((0.000000
     $  000000000D+00,-5.000000000000000D-01)) *TMP_JAMP(12)
        JAMP(8,1) = (-1.666666666666667D-01)*AMP( K,13) +((0.00000000000
     $  0000D+00,1.666666666666667D-01))*TMP_JAMP(12) +((0.000000000000000D+00,1
     $  .666666666666667D-01))*TMP_JAMP(13)
        JAMP(9,1) = (-1.666666666666667D-01)*AMP( K,6)+(-1.6666666666666
     $  67D -01)*AMP( K,8)+(-1.666666666666667D-01)*AMP( K,17)+( -1.666666666666
     $  667D-01)*AMP( K,18)
        JAMP(10,1) = (5.000000000000000D-01)*AMP( K,6)+(5.00000000000000
     $  0D -01)*AMP( K,7)+((0.000000000000000D+00,5.000000000000000D-01)) *AMP( 
     $  K,10)+(5.000000000000000D-01)*AMP( K,22)+(5.000000000000000D-01) *AMP( K
     $  ,23)+((0.000000000000000D+00,-5.000000000000000D-01)) *AMP( K,25)+((0.00
     $  0000000000000D+00,5.000000000000000D-01))*AMP( K,29) +((0.00000000000000
     $  0D+00,-5.000000000000000D-01))*AMP( K,31)+( -5.000000000000000D-01)*TMP_
     $  JAMP(14)
        JAMP(11,1) = (5.000000000000000D-01)*AMP( K,17)+(5.0000000000000
     $  00D -01)*AMP( K,19)+((0.000000000000000D+00,5.000000000000000D-01)) *AMP
     $  ( K,20)+(5.000000000000000D-01)*AMP( K,28)+((0.000000000000000D +00,-5.0
     $  00000000000000D-01))*AMP( K,29)+(5.000000000000000D-01) *TMP_JAMP(15)+((
     $  0.000000000000000D+00,5.000000000000000D-01)) *TMP_JAMP(16)
        JAMP(12,1) = (-1.666666666666667D-01)*AMP( K,22)+( -1.6666666666
     $  66667D-01)*AMP( K,24)+(-1.666666666666667D-01)*AMP( K,28) +((0.000000000
     $  000000D+00,-1.666666666666667D-01))*TMP_JAMP(17)
