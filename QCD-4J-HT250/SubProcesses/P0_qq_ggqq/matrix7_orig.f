...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1_1(W(1,1),W(1,7),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,5),W(1,10),W(1,9),GC_11,AMP(4))
      CALL FFV1_2(W(1,5),W(1,7),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,10),W(1,1),W(1,9),GC_11,AMP(5))
      CALL FFV1_1(W(1,1),W(1,3),GC_11,ZERO, FK_ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_2(W(1,5),W(1,4),GC_11,ZERO, FK_ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV1_2(W(1,5),W(1,3),GC_11,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,10),W(1,14),W(1,9),GC_11,AMP(16))
      CALL FFV1P0_3(W(1,10),W(1,1),GC_11,ZERO, FK_ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,11),W(1,1),W(1,9),GC_11,AMP(19))
...
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,12),W(1,1),W(1,11),GC_11,AMP(23))
...
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,7),W(1,1),W(1,9),GC_11,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,12),W(1,1),W(1,11),GC_11,AMP(31))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      TMP_JAMP(19) = TMP_JAMP(2) + ((0.000000000000000D+00,
     ...
     $ *TMP_JAMP(7)+(-5.000000000000000D-01)*TMP_JAMP(17)
     ...
     $ *TMP_JAMP(15)+(-5.000000000000000D-01)*TMP_JAMP(19)
      JAMP(5,1) = (-5.000000000000000D-01)*AMP(8)+((0.000000000000000D
     ...
     $ *TMP_JAMP(12)
      JAMP(6,1) = (-5.000000000000000D-01)*AMP(21)+(
     ...
     $ +00,-1.666666666666667D-01))*TMP_JAMP(13)
      JAMP(8,1) = (1.666666666666667D-01)*AMP(16)+(1.666666666666667D
     ...
     $ -01)*AMP(18)
      JAMP(10,1) = (-5.000000000000000D-01)*AMP(6)+(
     ...
     $ *TMP_JAMP(16)+(5.000000000000000D-01)*TMP_JAMP(18)
      JAMP(11,1) = (-5.000000000000000D-01)*AMP(11)+(
