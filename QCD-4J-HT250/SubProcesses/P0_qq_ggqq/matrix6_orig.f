...
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,13),W(1,2),W(1,11),GC_11,AMP(8))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1_1(W(1,2),W(1,3),GC_11,ZERO, FK_ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,12),W(1,5),W(1,10),GC_11,AMP(12))
...
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,7),W(1,5),W(1,9),GC_11,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,12),W(1,5),W(1,11),GC_11,AMP(31))
      CALL FFV1_2(W(1,13),W(1,3),GC_11,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,12),W(1,2),W(1,8),GC_11,AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,13),W(1,2),W(1,14),GC_11,AMP(33))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      TMP_JAMP(17) = AMP(1) +  AMP(2)  ! used 2 times
     ...
     $ ,1.000000000000000D+00)) * AMP(14)  ! used 2 times
      TMP_JAMP(11) = AMP(5) + ((-0.000000000000000D+00
     ...
     $ -1.000000000000000D+00)) * AMP(26)  ! used 2 times
      TMP_JAMP(6) = AMP(4) +  AMP(5)  ! used 2 times
      TMP_JAMP(5) = AMP(4) + ((0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(9)  ! used 2 times
      TMP_JAMP(4) = TMP_JAMP(2) + ((-0.000000000000000D+00,
     $ -1.000000000000000D+00)) * AMP(2)  ! used 2 times
      JAMP(1,1) = (5.000000000000000D-01)*AMP(8)+((0.000000000000000D
     $ +00,-5.000000000000000D-01))*AMP(10)+(5.000000000000000D-01)
     $ *AMP(32)+(5.000000000000000D-01)*TMP_JAMP(4)
     $ +((0.000000000000000D+00,-5.000000000000000D-01))*TMP_JAMP(5)
     $ +(5.000000000000000D-01)*TMP_JAMP(8)
      JAMP(2,1) = (5.000000000000000D-01)*AMP(21)+(5.000000000000000D
     $ -01)*AMP(24)+((0.000000000000000D+00,5.000000000000000D-01))
     $ *AMP(25)+(-5.000000000000000D-01)*TMP_JAMP(4)
     $ +((0.000000000000000D+00,5.000000000000000D-01))*TMP_JAMP(7)
     $ +(5.000000000000000D-01)*TMP_JAMP(9)
      JAMP(3,1) = (-1.666666666666667D-01)*AMP(7)+((0.000000000000000D
     $ +00,1.666666666666667D-01))*TMP_JAMP(5)+((0.000000000000000D+00
     $ ,1.666666666666667D-01))*TMP_JAMP(11)
      JAMP(4,1) = (-1.666666666666667D-01)*AMP(16)+(
     $ -1.666666666666667D-01)*AMP(19)+(-1.666666666666667D-01)*AMP(26)
     $ +((0.000000000000000D+00,-1.666666666666667D-01))*TMP_JAMP(6)
      JAMP(5,1) = (5.000000000000000D-01)*AMP(11)+(5.000000000000000D
     $ -01)*AMP(13)+((0.000000000000000D+00,5.000000000000000D-01))
     $ *AMP(15)+(5.000000000000000D-01)*AMP(16)+(5.000000000000000D-01)
     $ *AMP(18)+((0.000000000000000D+00,-5.000000000000000D-01))
     $ *AMP(20)+(-5.000000000000000D-01)*TMP_JAMP(8)+(
     $ -5.000000000000000D-01)*TMP_JAMP(9)
      JAMP(6,1) = (-1.666666666666667D-01)*AMP(11)+(
     $ -1.666666666666667D-01)*AMP(12)+(-1.666666666666667D-01)*AMP(21)
     $ +(-1.666666666666667D-01)*AMP(23)
      JAMP(7,1) = (5.000000000000000D-01)*AMP(12)+((0.000000000000000D
     $ +00,-5.000000000000000D-01))*AMP(15)+((0.000000000000000D+00
     ...
     $ *TMP_JAMP(12)
      JAMP(8,1) = (-1.666666666666667D-01)*AMP(13)
     $ +((0.000000000000000D+00,1.666666666666667D-01))*TMP_JAMP(12)
     $ +((0.000000000000000D+00,1.666666666666667D-01))*TMP_JAMP(13)
      JAMP(9,1) = (-1.666666666666667D-01)*AMP(6)+(-1.666666666666667D
     $ -01)*AMP(8)+(-1.666666666666667D-01)*AMP(17)+(
     $ -1.666666666666667D-01)*AMP(18)
      JAMP(10,1) = (5.000000000000000D-01)*AMP(6)+(5.000000000000000D
     ...
     $ *AMP(25)+((0.000000000000000D+00,5.000000000000000D-01))*AMP(29)
     $ +((0.000000000000000D+00,-5.000000000000000D-01))*AMP(31)+(
     $ -5.000000000000000D-01)*TMP_JAMP(14)
      JAMP(11,1) = (5.000000000000000D-01)*AMP(17)+(5.000000000000000D
     $ -01)*AMP(19)+((0.000000000000000D+00,5.000000000000000D-01))
     $ *AMP(20)+(5.000000000000000D-01)*AMP(28)+((0.000000000000000D
     $ +00,-5.000000000000000D-01))*AMP(29)+(5.000000000000000D-01)
     $ *TMP_JAMP(15)+((0.000000000000000D+00,5.000000000000000D-01))
     $ *TMP_JAMP(16)
      JAMP(12,1) = (-1.666666666666667D-01)*AMP(22)+(
     $ -1.666666666666667D-01)*AMP(24)+(-1.666666666666667D-01)*AMP(28)
