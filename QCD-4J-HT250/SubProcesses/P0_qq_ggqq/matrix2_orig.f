...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1P0_3(W(1,1),W(1,5),GC_11,ZERO, FK_ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1_1(W(1,5),W(1,4),GC_11,ZERO, FK_ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 20
      ...
      CALL FFV1_1(W(1,5),W(1,3),GC_11,ZERO, FK_ZERO,W(1,10))
      CALL FFV1_1(W(1,2),W(1,4),GC_11,ZERO, FK_ZERO,W(1,17))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      TMP_JAMP(2) = AMP(73) +  AMP(75)  ! used 4 times
      TMP_JAMP(1) = AMP(68) +  AMP(70)  ! used 4 times
      TMP_JAMP(35) = AMP(8) + ((-0.000000000000000D+00,
     $ -1.000000000000000D+00)) * AMP(49)  ! used 2 times
      TMP_JAMP(34) = AMP(8) + (3.000000000000000D+00) * AMP(9)  ! used 2 times
      TMP_JAMP(33) = AMP(2) + (3.333333333333333D-01) * AMP(7)  ! used 2 times
      TMP_JAMP(32) = TMP_JAMP(6) - TMP_JAMP(5)  ! used 2 times
      TMP_JAMP(31) = AMP(10) + ((0.000000000000000D+00,
     $ -1.000000000000000D+00)) * AMP(39)  ! used 2 times
      TMP_JAMP(30) = AMP(9) +  AMP(10)  ! used 2 times
      TMP_JAMP(29) = AMP(5) +  AMP(7)  ! used 2 times
     ...
     $ ,1.000000000000000D+00)) * AMP(66)  ! used 2 times
      ...
      TMP_JAMP(12) = TMP_JAMP(5) + ((-0.000000000000000D+00
     $ ,3.333333333333333D-01)) * AMP(5)  ! used 2 times
      TMP_JAMP(11) = TMP_JAMP(5) + ((-0.000000000000000D+00
     ...
     $ ,3.333333333333333D-01)) * AMP(1)  ! used 2 times
      TMP_JAMP(36) = TMP_JAMP(8) + ((0.000000000000000D+00,
     ...
     $ -1.666666666666667D-01))*TMP_JAMP(36)
     ...
     $ +(5.000000000000000D-01)*TMP_JAMP(15)+((0.000000000000000D+00
     $ ,5.000000000000000D-01))*TMP_JAMP(35)+((0.000000000000000D+00
     $ ,1.666666666666667D-01))*TMP_JAMP(36)
     ...
     $ -5.000000000000000D-01)*TMP_JAMP(16)+((0.000000000000000D+00
     $ ,5.000000000000000D-01))*TMP_JAMP(20)
     ...
     $ -1.666666666666667D-01))*TMP_JAMP(13)+(-5.000000000000000D-01)
     ...
     $ +(5.000000000000000D-01)*AMP(16)+((0.000000000000000D+00
     $ ,5.000000000000000D-01))*AMP(18)+(1.666666666666667D-01)*AMP(33)
     $ +(5.000000000000000D-01)*AMP(34)+(1.666666666666667D-01)*AMP(35)
     $ +(5.000000000000000D-01)*AMP(36)+((0.000000000000000D+00,
     $ -5.000000000000000D-01))*AMP(38)+(-5.000000000000000D-01)
     $ *TMP_JAMP(14)+(-5.000000000000000D-01)*TMP_JAMP(15)
     ...
     $ -5.000000000000000D-01))*AMP(20)+(-1.666666666666667D-01)
     ...
     $ +(5.000000000000000D-01)*TMP_JAMP(16)+(5.000000000000000D-01)
     $ *TMP_JAMP(17)
     ...
     $ +(5.000000000000000D-01)*TMP_JAMP(18)+((0.000000000000000D+00,
     $ -5.000000000000000D-01))*TMP_JAMP(19)+((0.000000000000000D+00,
     $ -1.666666666666667D-01))*TMP_JAMP(20)+((0.000000000000000D+00,
     $ -5.000000000000000D-01))*TMP_JAMP(23)+((0.000000000000000D+00,
     $ -1.666666666666667D-01))*TMP_JAMP(25)
      JAMP(8,1) = (-5.000000000000000D-01)*AMP(15)+(
     ...
     $ *TMP_JAMP(23)+((0.000000000000000D+00,1.666666666666667D-01))
     $ *TMP_JAMP(24)+((0.000000000000000D+00,5.000000000000000D-01))
     $ *TMP_JAMP(25)
      JAMP(9,1) = (-1.666666666666667D-01)*AMP(21)+(
     ...
     $ +(5.000000000000000D-01)*TMP_JAMP(26)
      JAMP(10,1) = (5.000000000000000D-01)*AMP(21)+(1.666666666666667D
     ...
     $ *TMP_JAMP(28)+((0.000000000000000D+00,5.000000000000000D-01))
     $ *TMP_JAMP(29)+((0.000000000000000D+00,1.666666666666667D-01))
     $ *TMP_JAMP(30)
     ...
     $ *TMP_JAMP(32)+((0.000000000000000D+00,-5.000000000000000D-01))
     $ *TMP_JAMP(33)+((0.000000000000000D+00,-1.666666666666667D-01))
     $ *TMP_JAMP(34)
