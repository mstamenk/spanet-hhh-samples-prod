...
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,9),W(1,6),W(1,8),GC_11,AMP(2))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1_1(W(1,6),W(1,4),GC_11,ZERO, FK_ZERO,W(1,7))
      CALL FFV1P0_3(W(1,1),W(1,10),GC_11,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,2),W(1,7),W(1,11),GC_11,AMP(6))
...
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,13),W(1,6),W(1,11),GC_11,AMP(8))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1_1(W(1,6),W(1,3),GC_11,ZERO, FK_ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,2),W(1,15),W(1,8),GC_11,AMP(14))
...
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,2),W(1,7),W(1,15),GC_11,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,13),W(1,6),W(1,15),GC_11,AMP(18))
...
C     Amplitude(s) for diagram number 20
      ...
      CALL FFV1P0_3(W(1,15),W(1,6),GC_11,ZERO, FK_ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,10),W(1,6),W(1,8),GC_11,AMP(24))
...
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,2),W(1,14),W(1,8),GC_11,AMP(28))
      CALL VVV1P0_1(W(1,3),W(1,8),GC_10,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,2),W(1,7),W(1,14),GC_11,AMP(29))
...
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,12),W(1,6),W(1,8),GC_11,AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,13),W(1,6),W(1,14),GC_11,AMP(33))
