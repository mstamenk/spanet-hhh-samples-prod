...
set xrange [1.4700e+00:2.9400e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
set format y '10^{%T}'
set yrange [1.7377e-07:1.3168e-03]
...
unset label
unset format
set yrange [-2.7644e-01:2.8673e-01]
...
set xrange [1.2600e+00:2.6700e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
set format y '10^{%T}'
set yrange [1.7377e-07:1.4994e-03]
set origin 0.0000e+00, 5.0000e-01
set size 1.0000e+00, 4.0000e-01
set mytics 10
set ytics auto
...
set xrange [8.7000e-01:2.4300e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
set format y '10^{%T}'
set yrange [1.7377e-07:1.6523e-03]
set origin 0.0000e+00, 5.0000e-01
set size 1.0000e+00, 4.0000e-01
set mytics 10
set ytics auto
...
set format y '10^{%T}'
set yrange [1.7377e-07:1.5695e-03]
set origin 0.0000e+00, 5.0000e-01
set size 1.0000e+00, 4.0000e-01
set mytics 10
set ytics auto
