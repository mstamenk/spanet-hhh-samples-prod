...
set xrange [1.4400e+00:2.7600e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
set format y '10^{%T}'
set yrange [1.7366e-07:1.4094e-03]
...
unset label
unset format
set yrange [-2.4782e-01:2.3913e-01]
...
set xrange [1.1700e+00:2.6700e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
set format y '10^{%T}'
set yrange [1.7366e-07:1.5049e-03]
set origin 0.0000e+00, 5.0000e-01
set size 1.0000e+00, 4.0000e-01
set mytics 10
set ytics auto
...
set xrange [8.7000e-01:2.4000e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
set format y '10^{%T}'
set yrange [1.7366e-07:1.5898e-03]
set origin 0.0000e+00, 5.0000e-01
set size 1.0000e+00, 4.0000e-01
set mytics 10
set ytics auto
...
set xrange [6.3000e-01:2.3400e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
set format y '10^{%T}'
set yrange [1.7366e-07:1.5664e-03]
set origin 0.0000e+00, 5.0000e-01
set size 1.0000e+00, 4.0000e-01
set mytics 10
set ytics auto
