...
set format y '10^{%T}'
set yrange [1.7398e-07:1.3566e-03]
...
unset label
unset format
set yrange [-4.6640e-01:1.2365e+00]
...
set xrange [1.2900e+00:2.9100e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
set format y '10^{%T}'
set yrange [1.7398e-07:1.4863e-03]
set origin 0.0000e+00, 5.0000e-01
set size 1.0000e+00, 4.0000e-01
set mytics 10
set ytics auto
...
set xrange [9.0000e-01:2.4900e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
set format y '10^{%T}'
set yrange [1.7398e-07:1.7139e-03]
set origin 0.0000e+00, 5.0000e-01
set size 1.0000e+00, 4.0000e-01
set mytics 10
set ytics auto
...
set xrange [7.8000e-01:2.3100e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
set format y '10^{%T}'
set yrange [1.7398e-07:1.5246e-03]
set origin 0.0000e+00, 5.0000e-01
set size 1.0000e+00, 4.0000e-01
set mytics 10
set ytics auto
