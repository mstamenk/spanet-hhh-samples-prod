...
set format y '10^{%T}'
set yrange [1.7365e-07:1.2947e-03]
...
unset label
unset format
set yrange [-2.8763e-01:2.8344e-01]
...
set xrange [1.2000e+00:2.7900e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
set format y '10^{%T}'
set yrange [1.7365e-07:1.4559e-03]
set origin 0.0000e+00, 5.0000e-01
set size 1.0000e+00, 4.0000e-01
set mytics 10
set ytics auto
...
set xrange [8.4000e-01:2.5200e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
set format y '10^{%T}'
set yrange [1.7365e-07:1.6385e-03]
set origin 0.0000e+00, 5.0000e-01
set size 1.0000e+00, 4.0000e-01
set mytics 10
set ytics auto
...
set xrange [7.8000e-01:2.1900e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
set format y '10^{%T}'
set yrange [1.7365e-07:1.5451e-03]
set origin 0.0000e+00, 5.0000e-01
set size 1.0000e+00, 4.0000e-01
set mytics 10
set ytics auto
