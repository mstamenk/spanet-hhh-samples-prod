...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WH)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL SXXXXX(P(0,1),-1*IC(1),W(1,1)) ! count 2
      CALL OXXXXX(P(0,2),MDL_MB,+1,+1*IC(2),W(1,2)) ! count 1
      CALL OXXXXX(P(0,2),MDL_MB,-1,+1*IC(2),W(1,3)) ! count 1
      CALL IXXXXX(P(0,3),MDL_MB,+1,-1*IC(3),W(1,4)) ! count 1
      CALL IXXXXX(P(0,3),MDL_MB,-1,-1*IC(3),W(1,5)) ! count 1
      CALL FFS1_0(W(1,4),W(1,2),W(1,1),GC_33,AMP(2,1))
      CALL FFS1_0(W(1,5),W(1,3),W(1,1),GC_33,AMP(1,1)) ! count 1
