...
C     Storing concatenated filenames
      ...
      DATA (CONFIG_MAP(I),I=     1,     6) /     1,     0,     2,    
     $  0,     3,     0/
      DATA (CONFIG_MAP(I),I=     7,    12) /     0,     1,     0,    
     $  2,     0,     3/
      DATA (CONFIG_MAP(I),I=    13,    18) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    19,    24) /     0,     0,     1,    
     $  0,     0,     2/
      DATA (CONFIG_MAP(I),I=    25,    30) /     0,     0,     3,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    31,    36) /     1,     0,     0,    
     $  0,     0,     2/
      DATA (CONFIG_MAP(I),I=    37,    42) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    43,    48) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    49,    54) /     3,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    55,    60) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    61,    66) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    67,    72) /     0,     0,     0,    
     $  0,     1,     0/
      DATA (CONFIG_MAP(I),I=    73,    78) /     0,     2,     0,    
     $  0,     3,     0/
      DATA (CONFIG_MAP(I),I=    79,    84) /     0,     0,     1,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    85,    90) /     0,     2,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    91,    96) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=    97,   102) /     0,     0,     3,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   103,   108) /     0,     0,     0,    
     $  0,     0,     0/
      DATA (CONFIG_MAP(I),I=   109,   114) /     0,     0,     0,    
     $  0,     0,     0/
...
C     
      ...
      DATA (CONFIG_INDEX_MAP(I),I=     1,     3) /     7,    10,    13/
C     
C     ARGUMENTS
C     
      INTEGER HEL_MULT
