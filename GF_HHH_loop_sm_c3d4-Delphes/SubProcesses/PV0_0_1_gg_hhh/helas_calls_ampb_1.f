...
C     Counter-term amplitude(s) for loop diagram number 8
      CALL R2_GGHH_0(W(1,1),W(1,2),W(1,5),W(1,6),R2_GGHHB,AMPL(1,2))
      CALL SSS1_1(W(1,3),W(1,5),GC_30,MDL_MH,MDL_WH,W(1,8))
      CALL SSS1_1(W(1,4),W(1,8),GC_30,MDL_MH,MDL_WH,W(1,9))
C     Counter-term amplitude(s) for loop diagram number 10
      CALL VVS1_0(W(1,1),W(1,2),W(1,9),R2_GGHB,AMPL(1,3))
C     Counter-term amplitude(s) for loop diagram number 11
      CALL R2_GGHH_0(W(1,1),W(1,2),W(1,4),W(1,8),R2_GGHHB,AMPL(1,4))
      CALL SSS1_1(W(1,4),W(1,5),GC_30,MDL_MH,MDL_WH,W(1,10))
      CALL SSS1_1(W(1,3),W(1,10),GC_30,MDL_MH,MDL_WH,W(1,11))
C     Counter-term amplitude(s) for loop diagram number 13
      CALL VVS1_0(W(1,1),W(1,2),W(1,11),R2_GGHB,AMPL(1,5))
C     Counter-term amplitude(s) for loop diagram number 14
      CALL R2_GGHH_0(W(1,1),W(1,2),W(1,10),W(1,3),R2_GGHHB,AMPL(1,6))
      CALL SSSS1_1(W(1,3),W(1,4),W(1,5),GC_HHHH,MDL_MH,MDL_WH,W(1,12))
C     Counter-term amplitude(s) for loop diagram number 16
      CALL VVS1_0(W(1,1),W(1,2),W(1,12),R2_GGHB,AMPL(1,7))
C     Counter-term amplitude(s) for loop diagram number 57
      CALL VVS1_0(W(1,1),W(1,2),W(1,7),R2_GGHT,AMPL(1,8))
C     Counter-term amplitude(s) for loop diagram number 58
      CALL R2_GGHH_0(W(1,1),W(1,2),W(1,5),W(1,6),R2_GGHHT,AMPL(1,9))
C     Counter-term amplitude(s) for loop diagram number 60
      CALL VVS1_0(W(1,1),W(1,2),W(1,9),R2_GGHT,AMPL(1,10))
C     Counter-term amplitude(s) for loop diagram number 61
      CALL R2_GGHH_0(W(1,1),W(1,2),W(1,4),W(1,8),R2_GGHHT,AMPL(1,11))
C     Counter-term amplitude(s) for loop diagram number 63
      CALL VVS1_0(W(1,1),W(1,2),W(1,11),R2_GGHT,AMPL(1,12))
C     Counter-term amplitude(s) for loop diagram number 64
      CALL R2_GGHH_0(W(1,1),W(1,2),W(1,10),W(1,3),R2_GGHHT,AMPL(1,13))
C     Counter-term amplitude(s) for loop diagram number 66
      CALL VVS1_0(W(1,1),W(1,2),W(1,12),R2_GGHT,AMPL(1,14))
